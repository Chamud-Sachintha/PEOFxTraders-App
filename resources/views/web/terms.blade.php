                    ...
                    <div class="row">
                        ...
                        <div class="header-img wpb_column vc_column_container vc_col-sm-6">
                            <div class="vc_column-inner ">
                                <div class="wpb_wrapper">
                                    <div class="img-wrap">
                                        <img src="{{asset('web/images/about.png')}}" style="min-width: 0;" alt>
                                    </div>
                ...
                <div class="row">
                    <div class="wpb_column vc_column_container vc_col-sm-12">
                        <div class="vc_column-inner ">
                            <div class="wpb_wrapper">
                                <p>
                                    Welcome to PEOFX! At our company, we are committed to providing our users with a secure, fast, and cost-effective way to deposit cryptocurrencies into their accounts.
                                </p>
                                <p>
                                    Our team consists of experienced professionals and technical experties who are passionate about cryptocurrency and the benefits it can provide. We believe that cryptocurrency has the potential to revolutionize the financial industry, and we are dedicated to making it accessible to everyone.
                                </p>
                                <p>
                                    We understand that security is paramount when it comes to cryptocurrency, and we have implemented a range of security measures to protect our users' funds and personal information. Our website is equipped with SSL encryption, two-factor authentication, and cold storage solutions to ensure that users' deposits are safe and secure.
                                </p>
                                <p>
                                    We are registered with regulatory bodies and hold licenses and certifications that demonstrate our commitment to regulatory compliance. This helps to establish our credibility and reassure our users that we operate in a transparent and trustworthy manner. 
                                </p>
                                <p>
                                    If you have any questions or concerns, our customer support team is always available to assist you. We are committed to providing our users with a top-quality experience and helping them achieve their financial goals through the use of cryptocurrency. 
                                </p>
                                <p>Thank you for choosing PEOFX , and we look forward to serving you!</p>
                            </div>
                        </div>
                    </div>
