...
<head>
    ...
    <title>PeoFx &#8211; Cryptocurrency Trading Platform</title>
    ...
    <link rel="stylesheet" id="wp-block-library-css" href="{{asset('web/css/style.min.css')}}" type="text/css"
        media="all">
    <link rel="stylesheet" id="classic-theme-styles-css" href="{{asset('web/css/classic-themes.min.css')}}"
    ...
    <link rel="stylesheet" id="contact-form-7-css" href="{{asset('web/css/styles.css')}}" type="text/css" media="all">
    <link rel="stylesheet" id="coeus-fonts-css"
        ...
        type="text/css" media="all">
    <link rel="stylesheet" id="coeus-bootstrap-css" href="{{asset('web/css/bootstrap.min.css')}}" type="text/css"
        media="all">
    <link rel="stylesheet" id="coeus-font-awesome-css" href="{{asset('web/css/font-awesome.min.css')}}" type="text/css"
        media="all">
    <link rel="stylesheet" id="coeus-owl-carousel-css" href="{{asset('web/css/owl.carousel.css')}}" type="text/css"
        media="all">
    <link rel="stylesheet" id="coeus-transitions-css" href="{{asset('web/css/owl.transitions.css')}}" type="text/css"
        media="all">
    <link rel="stylesheet" id="coeus-style-css" href="{{asset('web/css/style.css')}}" type="text/css" media="all">
    ...
    <link rel="stylesheet" id="js_composer_front-css" href="{{asset('web/css/js_composer.min.css')}}" type="text/css"
        media="all">
    <script type="text/javascript" src="{{asset('web/js/jquery.min.js')}}" id="jquery-core-js"></script>
    <script type="text/javascript" src="{{asset('web/js/jquery-migrate.min.js')}}" id="jquery-migrate-js"></script>
    <script type="text/javascript" src="{{asset('web/js/jquery.countdown.min.js')}}" id="coeus-countdown-js"></script>
    ...
    <link rel="EditURI" type="application/rsd+xml" title="RSD"
        href="http://wpdemo.oceanthemes.net/coeus/xmlrpc.php?rsd">
...
<body
                ...
                <div class="col-12">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light mx-lg-0">
                        <a class="navbar-brand" href="/">
                            <img src="{{asset('web/images/logo.png')}}" alt="Coeus" style="width: 105px;">
                        </a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <div class="header-btn">
                                <a class="btn btn-primary js-tilt" href="/signin" role="button"
    ...
    <section class="wpb-content-wrapper">
        <section
            class="wpb_row vc_row-fluid height-auto-lg hide-over vc_custom_1539743301695 vc_row-has-fill full-height">
                    ...
                    <div class="row">
                        <div
                            ...
                            <div class="vc_column-inner ">
                                <div class="wpb_wrapper">
                                    <h2 style="text-align: left" class="vc_custom_heading">Projects</h2>
                                    <div class="wpb_text_column wpb_content_element  mt-3 mb-4 pb-3 font-weight-normal">
                                        <div class="wpb_wrapper">
                                            <p>Welcome to PEOFX! At our company, we are committed to providing our users with a secure, fast, and cost-effective way to deposit cryptocurrencies into their accounts.</p>
                        ...
                        <div class="header-img wpb_column vc_column_container vc_col-sm-6">
                            <div class="vc_column-inner ">
                                <div class="wpb_wrapper">
                                    <div class="img-wrap">
                                        <img src="{{asset('web/images/project_page.png')}}" style="min-width: 0;" alt>
                                    </div>
        ...
        <section id="contact" class="wpb_row vc_row-fluid vc_custom_1528791436893" style="margin-top: -70px">
            <div class="container">
                <div class="row">
                        ...
                        <div class="vc_column-inner ">
                            <div class="wpb_wrapper">
                                ...
                                <div style="margin-left: 30px">
                                    <ul>
                                        <li>
                                            We developed a forex trading strategy that aligns with Peofx overall business goals and risk appetite. We involve conducting market research, analyzing historical data, and testing different trading algorithms.
                                        </li>
                                        <li>
                                            We Hired experienced forex traders. Forex trading requires specialized knowledge and experience, so we hired experienced traders who understand the market and can execute trading strategy effectively.
                                        </li>
                                        <li>
                                            Forex trading is subject to a range of regulatory requirements, so we have the necessary compliance protocols in place to meet these requirements.
                                        </li>
                                        <li>
                                            Forex trading can be highly volatile and risky, so we developed robust risk management protocols to minimize the risk of losses.
                                        </li>
                                        <li>
                                            We monitored the performance of forex trading strategy and adjust it as needed to ensure that it aligns with our goals and risk appetite.
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <span style="font-size: 16px">
                                    <ol type="1" start="2">
                                        <li>Solar power Crypto mining</li>
                                    </ol>
                                </span>
                                <div style="margin-left: 30px">
                                    <ul>
                                        <li>
                                            Reduced energy costs: Cryptocurrency mining is an energy-intensive process that can be costly, but using solar power can significantly reduce energy expenses.
                                        </li>
                                        <li>
                                            Eco-friendliness: Cryptocurrency mining can have a significant environmental impact due to the energy required, but using solar power can help to mitigate these effects and promote eco-friendliness.
                                        </li>
                                        <li>
                                            Positive brand image: By embracing sustainable energy sources, the cryptocurrency deposit website can demonstrate a commitment to environmental sustainability and improve its brand image.
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div style="margin-left: 30px">
                                    <ul>
                                        <li>
                                            Increased engagement: Creating a game that utilizes cryptocurrency as a form of in-game currency can increase engagement with users, providing them with an additional reason to use the cryptocurrency deposit website.
                                        </li>
                                        <li>
                                            Opportunity for promotion: A game that utilizes cryptocurrency as a form of in-game currency can provide an opportunity to promote the cryptocurrency deposit website to a wider audience.
                                        </li>
                                        <li>
                                            Creating a game that utilizes cryptocurrency as a form of in-game currency can demonstrate innovation and a commitment to the cryptocurrency industry.
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <span style="font-size: 16px">
                                    <ol type="1" start="4">
                                        <li>We offer new plans for new product features and improvements to existing features. We are     planning to introduce support for new cryptocurrencies, develop a mobile app for users to deposit funds on-the-go.</li>
                                    </ol>
                                </span>
                                <span style="font-size: 16px">
                                    <ol type="1" start="5">
                                        <li> We are partnering with other popular cryptocurrency exchanges and payment processors to enable seamless transfers of cryptocurrencies between platforms and deposit experience for users.</li>
                                    </ol>
                                </span>
                                <span style="font-size: 16px">
                                    <ol type="1" start="6">
                                        <li>We Explore opportunities to expand the website's services into new geographic markets, enabling users in different countries to deposit cryptocurrencies into their accounts.</li>
                                    </ol>
                                </span>
                                <span style="font-size: 16px">
                                    <ol type="1" start="7">
                                        <li>We Consider the development of additional security measures such as biometric authentication or decentralized identity systems to make the deposit process even more secure.</li>
                                    </ol>
                                </span>
                                <span style="font-size: 16px">
                                    <ol type="1" start="8">
                                        <li>improve the Peofx's user interface and user experience to make it more intuitive and user-friendly for both experienced and novice users.</li>
                                    </ol>
                                </span>
                                <span style="font-size: 16px">
                                    <ol type="1" start="9">
                                        <li>Develop educational initiatives to help users better understand the cryptocurrency deposit process, the benefits of investing in cryptocurrency, and how to securely manage their digital assets.</li>
                                    </ol>
                                </span>
                            </div>
                        </div>
    ...
    <div class="section-footer section padding-top-big">
        <div class="background-parallax"
            style="background-image: url(&#x27;{{asset('web/images/parallax-5.jpg')}}&#x27;)" data-enllax-ratio=".5"
                                ...
                                <div class="wpb_wrapper">
                                    <div class="wpb_text_column wpb_content_element ">
                                        <div class="wpb_wrapper">
                                            ...
                                            <form id="mc4wp-form-1" class="mc4wp-form mc4wp-form-166" method="post"
                                                data-id="166" data-name>
                                                <div class="mc4wp-form-fields">
                                                    ...
                                                    <div class="suscribe">
                                                        ...
                                                        <button type="submit" class="btn btn-primary m-0 js-tilt"
                                                            data-tilt-perspective="300" data-tilt-speed="700"
                                                            data-tilt-max="24"><span>subscribe</span></button>
                                                    </div>
                                                    <p class="text-left text-white mb-0"><small>* we promise that we
                                                            won´t spam you,
                                                            never.</small></p>
                                                    ...
                                                    name="_mc4wp_timestamp" value="1677997446"><input type="hidden"
                                                    name="_mc4wp_form_id" value="166"><input type="hidden"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 footer text-center text-lg-left">
                        <p>© Copyright 2023 - All Rights Recieved By PeoFx.com <br> Design & Developed By <a
                                href="https://www.builtonus.com/">BuiltOnUs.com</a></p>
                    </div>
                    <div class="col-lg-6 footer mt-4 mr-auto mt-lg-0 mr-lg-0 text-center text-lg-right">
                        ...
                        <div class="social">
                            ...
                            <a class="app-btn mx-2 mr-lg-3" href="#" target="_self"><i
    ...
    <script type="text/javascript" src="{{asset('web/js/index_1.js')}}" id="swv-js"></script>
    <script type="text/javascript" id="contact-form-7-js-extra">
        /* <![CDATA[ */
        var wpcf7 = { "api": { "root": "http:\/\/wpdemo.oceanthemes.net\/coeus\/wp-json\/", "namespace": "contact-form-7\/v1" } };
/* ]]> */
    </script>
    <script type="text/javascript" src="{{asset('web/js/index.js')}}" id="contact-form-7-js"></script>
    <script type="text/javascript" src="{{asset('web/js/popper.min.js')}}" id="coeus-popper-js"></script>
    <script type="text/javascript" src="{{asset('web/js/bootstrap.min.js')}}" id="coeus-bootstrap-js"></script>
    <script type="text/javascript" src="{{asset('web/js/plugins.js')}}" id="coeus-plugins-js"></script>
    <script type="text/javascript" src="{{asset('web/js/shape-svg.js')}}" id="coeus-shape-js"></script>
    <script type="text/javascript" src="{{asset('web/js/canvas-x-o.js')}}" id="coeus-xo-js"></script>
    <script type="text/javascript" src="{{asset('web/js/particles.js')}}" id="coeus-particles-js"></script>
    <script type="text/javascript" src="{{asset('web/js/custom.js')}}" id="coeus-custom-js"></script>
    <script type="text/javascript" src="{{asset('web/js/js_composer_front.min.js')}}"
        id="wpb_composer_front_js-js"></script>
    <script type="text/javascript" defer src="{{asset('web/js/forms.js')}}" id="mc4wp-forms-api-js"></script>
