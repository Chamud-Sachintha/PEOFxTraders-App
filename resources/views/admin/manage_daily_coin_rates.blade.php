        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/updateSelectedPackageById" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="mb-1"><strong>Coin Name</strong></label>
                                    <input type="text" id="coinName" class="form-control" placeholder="Eg. " name="coin_name" value="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label class="mb-1"><strong>Coin Rate</strong></label>
                                    <input type="text" id="coinRate" class="form-control" placeholder="Eg. " name="coin_rate" value="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                @endif
                                <h5 class="card-title">Manage Daily Rates</h5>
                                <hr>
                                <form action="/createNewCoinRate" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label class="mb-1"><strong>Coin Name</strong></label>
                                                <input type="text" class="form-control" placeholder="Eg. 123-456" name="coin_name">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label class="mb-1"><strong>Coin Rate</strong></label>
                                                <input type="text" class="form-control" placeholder="Eg. 123-456" name="coin_rate">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <input type="submit" class="btn btn-primary btn-sm" value="Add Rate">
                                        </div>
                                    </div>
                                </form>
                                ...
                                <div class="row mt-3">
                                    <div class="col-12">
                                        <h5 class="card-title">All Coin Rates</h5>
                                        <hr>
                                        <table class="table" id="coinRateTable">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>Coin Name</th>
                                            ...
                                            <tbody>
                                                @foreach($all_rates as $each_rate)
                                                    <tr>
                                                        <td>{{ $each_rate['id'] }}</td>
                                                        <td>{{ $each_rate['coin_name'] }}</td>
                                                        <td>{{ $each_rate['coin_rate'] }}</td>
                                                        <td>{{ $each_rate['status'] }}</td>
                                                        <td>
                                                            <a href="" class="bn btn-primary btn-sm view" data-toggle="modal" data-target="#exampleModalCenter">Update</a>
                                                            <a href="/deleteCoinRateById/{{ $each_rate['id'] }}" class="btn btn-danger btn-sm">Delete</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
    ...
    ***********************************-->
    ...
    <script>
        $(document).ready(function () {
            var table = $('#coinRateTable').DataTable({
                pageLength: 3
            });
